...
class AccountControllerTest {
    ...
    void canGetAllAccounts() throws Exception {
        ...
        given(accountServiceTest.getAllAccounts()).willReturn(listOfAccounts);
        //when
    ...
    void canRetrieveCustomerAccount() throws Exception {
        ...
        given(customerRepositoryTest.findById(customer.getId())).willReturn(Optional.of(customer));
        given(accountServiceTest.getAllCustomerAccounts(customer.getId())).willReturn(listOfAccounts);
        //when
    ...
    void canCreateCustomerAccount() throws Exception {
        //given
        given(accountServiceTest.createCustomerAccount(anyInt(),any(Account.class))).willReturn(account);
        //when
    ...
    void deleteAccountById() throws Exception {
        //given
        given(customerRepositoryTest.findById(customer.getId())).willReturn(Optional.of(customer));
        given(accountServiceTest.getAllCustomerAccounts(account.getId())).willReturn(customer.getAccount());
        //when
    ...
    void editAccountName() throws Exception {
        ...
        given(accountServiceTest.getAllCustomerAccounts(account.getId())).willReturn(customer.getAccount());
        given(accountServiceTest.getAllCustomerAccounts(editedAccount.getId())).willReturn(customer.getAccount());
        //when
